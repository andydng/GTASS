        ...
        if(floor($datediff/(60*60*24))>=2){ // If the deadline is 2 days or more away
            ...
            if(floor($datediff/(60*60*24))==2){  //if it's exactly 2 days
                ...
                if(strcmp($row['verified'],"Y")!=0)// if not verified, send reminder only
                    mail($row['faculty_email'],"Reminder to complete nomination Verification"," Hello Nominator,<br><br> This is a reminder! You have 2 days to login and review the submission for ".$row['first_name']).".<br><br><br><br>";
            }
        }
    }
