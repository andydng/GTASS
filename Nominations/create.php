...
<html>
  ...
  <body>
    ...
    <form id = "login-form" action = "<?php $_PHP_SELF ?>" method = "post">
      ...
      <label>PID  :</label><input type = "text" name = "pid" class = "box" /><br/><br />
      <label>Email  :</label><input type = "text" name = "email" placeholder = "email@domain.com"  class = "box" /><br/><br />
      
      <label>Rank :</label>
      <select name="rank" form="login-form" class="dropdown">
      ...
      <div class = "radio-group">
        <label >Current Ph.D.? :</label>
          <div class = "radio-options">
            <input type="radio" name="isphd" value="Y" checked> Yes
            <input type="radio" name="isphd" value="N"> No
          </div>
      </div>
      <br />
      <div class = "radio-group">
        <label>New Ph.D.? :</label>
          <div class = "radio-options">
            <input type="radio" name="newphd" value="Y" checked> Yes
            <input type="radio" name="newphd" value="N"> No
          </div>
      </div>
